...
declare const TooltipBox: _stitches_react_types_styled_component.StyledComponent<"div", {}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: {
        white: string;
        black: string;
        gray100: string;
...
interface TooltipProps extends ComponentProps<typeof TooltipBox> {
    children: string;
}
...
declare function Toast({ title, subtitle, type }: ToastProps): react_jsx_runtime.JSX.Element;
